  ...
  group "postfix" {
    ...
    task "postfix" {
      ...
      config {
        ...
        volumes = [
          "local:/etc/postfix/overlay",
        ]
      }

      env {
        POSTFIX_MYHOSTNAME="example.com"
        POSTFIX_MXHOSTNAME="mx.example.com"
        POSTFIX_MYDESTINATION="localhost"
        POSTFIX_VIRTUAL_ALIAS_DOMAINS="example.com example.net"
      }
      ...
      template {
        data = <<EOH
          me@example.com somebody@gmail.com
        EOH
        destination = "local/virtual"
        change_mode = "signal"
